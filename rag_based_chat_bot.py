# -*- coding: utf-8 -*-
"""RAG based Chat Bot.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DNcDerPbqhPDhL2GtZwssTriv-Oi8AMC
...
class cbfs(param.Parameterized):
    ...
    def __init__(self,  **params):
        ...
        self.loaded_file = uploaded
        #self.loaded_file = '/content/drive/MyDrive/Colab_Notebooks/Agentic_AI_by_PwC_1740924150.pdf'
        #self.loaded_file = Path.cwd() / "Agentic_AI_by_PwC_1740924150.pdf"
        self.qa = load_db(self.loaded_file,"stuff", 4)


        #self.loaded_file = Path("Agentic_AI_by_PwC_1740924150.pdf")
        #self.qa = load_db(str(self.loaded_file), "stuff", 4)
